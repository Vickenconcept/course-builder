    ...
    <div class="flex items-center justify-center h-96">
        <div class="p-4 rounded shadow-lg ring ring-indigo-600/50">
          <div class="flex flex-col items-center space-y-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="text-red-600 w-28 h-28"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              
            <h1 class="text-4xl font-bold">Cancle</h1>
            <p>Payment Cancled successfully, You can return back.</p>
            <a href="/"
