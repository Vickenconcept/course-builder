                ...
                <div class="shadow ">
                    <form action="{{ route('course-validation.create') }}" method="get">
                        ...
                        <div class="relative flex items-center w-full h-10 rounded-lg focus-within:shadow-lg bg-white overflow-hidden">
                            ...
                            <input autocomplete="off" class="peer h-full w-full outline-none border-none focus:none focus:border-none focus:ring-white  text-sm  pr-2 placeholder-gray-300" type="text" name="query" id="query" placeholder="Search..." />
                        </div>
                    </form>
                </div>
                @if(isset($query))
        ...
        <section class="py-2 overflow-x-auto ">
            <table class=" w-full mt-3  table-fixed ">
                ...
                <tbody class="">
                    ...
                    @empty
                    <tr>
                        <td class=" whitespace-nowrap text-xs py-2 px-6  truncate w-[120px] " colspan="3">no data</td>
                    </tr>
                    @endforelse
                    @endif
