                        ...
                        {{-- <form class="mt-6 border-t border-gray-400 pt-4"> --}}
                            <div class='flex flex-wrap -mx-3 mb-6'>
                                <div class="personal w-full border-t border-gray-400 pt-4">
                                    <h2 class="text-2xl text-gray-900">Course Settings:</h2>
                                    <div class="flex items-center justify-between mt-4">
                                      <form action="{{ route('course-setting.update', ['course_setting' => $id]) }}"  method="post">
                                        @method('PUT')
                                        @csrf
                                        <div class='w-full px-3 mb-6'>
                                            <label
                                                class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Free Course Count</label>
                                            <input
                                                ...
                                                type='number' value="{{  $freeLessonCount }}" required name="free_lessons_count">
                                                <x-main-button type="submit" class="hidden md:flex">Update</x-main-button>
                                        </div>
                                    </form> 
