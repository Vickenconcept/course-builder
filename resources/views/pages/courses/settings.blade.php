                ...
                <div class="container mx-auto">
                    <div class="inputs w-full max-w-2xl p-6 mx-auto">
                        ...
                        <div class='w-full md:w-full px-3 mb-6' x-show="selected === 'mailchimp'">
                            <label
                                class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Select Mailchimp Audience</label>
                            <div class="flex-shrink w-full inline-block relative">
                                <form action="{{ route('course-setting.saveSetting', ['courseId' => $course]) }}" method="POST">
                                    @csrf
                        ...
                        <div class='w-full md:w-full px-3 mb-6' x-show="selected === 'getresponse'">
                            <label
                                class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Select Get Response Audience</label>
                            <div class="flex-shrink w-full inline-block relative">
