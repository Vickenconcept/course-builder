            ...
            <form wire:submit.prevent="store" id="myForm" x-data>
                ...
                <div class="grid grid-cols-1 gap-8  ">
                    <div class="w-full col-span-1">
                        <i class='bx bx-bulb text-blue-500 text-xl '></i> <label for="topic" class="   bg-white   px-3 rounded  transition duration-300 py-2 text-xs">Topic/Title</label>
                        <div class="ml-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <div class="w-full col-span-1 ">
                            ...
                            <label for="presentation" class="    bg-white   px-3 rounded  transition duration-300 py-2 text-xs">presentation Presentation of Books</label>
                            <div class="ml-5">
                                <select id="presentation" name="presentation" wire:model="presentation" class="   bg-white border mt-3 border-gray-300 shadow text-gray-300 text-sm rounded-lg  block w-full p-2.5     ">
                                    <option selected class="text-blue-50 "  disabled>Course</option>
                                    <option value="Summaries and key takeaways" class="  ">Summaries and key takeaways</option>
                                    <option value="In-depth analysis and case studies" class="  ">In-depth analysis and case studies</option>
                                    <option value="Step-by-step tutorials and exercises" class="  ">Step-by-step tutorials and exercises</option>
                                </select>
                            </div>
                        </div>
                        <div class="w-full col-span-1 ">
                            <i class='bx bx-bulb text-blue-500  text-xl'></i>
                            <label for="level" class="   bg-white   px-3 rounded  transition duration-300 py-2 text-xs">Beginner, Intermidiate,Advance</label>
                            <div class="ml-5">
                                <select id="level" name="level" wire:model="level" class="   bg-white border mt-3 border-gray-300 shadow text-gray-300 text-sm rounded-lg  block w-full p-2.5     ">
                        ...
                        <div class="w-full col-span-1 ">
                            <i class='bx bx-bulb text-blue-500  text-xl'></i>
                            <label for="outline" class="   bg-white   px-3 rounded  transition duration-300 py-2 text-xs">Outline, Description,Summary</label>
                            <div class="ml-5">
                                <select id="outline" name="outline" wire:model="outline" class="   bg-white border mt-3 border-gray-300 shadow text-gray-300 text-sm rounded-lg  block w-full p-2.5     ">
                                    <!-- <option selected class="text-blue-50 " disabled>(Optional)</option> -->
                        ...
                        <div class="w-full col-span-1 ">
                            <i class='bx bx-bulb text-blue-500  text-xl'></i>
                            <label for="modules" class="   bg-white   px-3 rounded  transition duration-300 py-2 text-xs">How Many Modules Of Chapters</label>
                            <div class="ml-5">
                                <select id="modules" name="modules" wire:model="modules" class="   bg-white border mt-3 border-gray-300 shadow text-gray-300 text-sm rounded-lg  block w-full p-2.5     ">
                                    <option selected class="text-blue-50 "  disabled>(Optional)</option>
                        ...
                        <div class="w-full col-span-1 ">
                            <i class='bx bx-bulb text-blue-500  text-xl'></i>
                            <label for="formatting" class="   bg-white   px-3 rounded  transition duration-300 py-2 text-xs">Any Formatting</label>
                            <div class="ml-5">
                                <select id="formatting" name="formatting" wire:model="formatting" class="   bg-white border mt-3 border-gray-300 shadow text-gray-300 text-sm rounded-lg  block w-full p-2.5     ">
                                    <option selected class="text-blue-50 "  disabled>(Optional)</option>
                                    <option value=" format the course  " class="">Yes</option>
                                    <option value="don't formart the course" class="">No</option>
                                    <option value="you can choose to formart of not " class="">No preference</option>
                                </select>
                            </div>
                        </div>
                        <div class="w-full col-span-1 ">
                            <i class='bx bx-bulb text-blue-500  text-xl'></i>
                            <label for="time" class="   bg-white   px-3 rounded  transition duration-300 py-2 text-xs">Prefered Total Course Time (hours)?</label>

                            <div class="ml-5">
                                <select id="time" name="time" wire:model="time" class="   bg-white border mt-3 border-gray-300 shadow text-gray-300 text-sm rounded-lg  block w-full p-2.5     ">
                                    <option selected class="text-blue-50 "  disabled>(Optional)</option>
                    ...
                    <div class=" grid grid-cols-1 sm:grid-cols-2 gap-5 col-span-1  w-full ml-0 lg:ml-5 pr-0 lg:pr-5">
                        ...
                        <button type="button" @click="document.getElementById('myForm').reset()" class="uppercase justify-center border border-yellow-900 text-xs rounded hover:shadow-lg font-medium bg-transparent text-gray-700 px-2 py-3">Clear Input</button>
                    </div>
                </div>
            </form>
        </section>

        <section class="shadow-lg py-3 bg-white col-span-1 rounded px-10 text-sm  h-[100vh] overflow-y-auto my-10 md:my-0">
            <div class="flex flex-row ">
                ...
                <button onclick="toCopy(document.getElementById('content'))"><i class='bx bx-copy text-xl  hover:text-blue-800 cursor-pointer'></i></button>
                <button>
