                                ...
                                <x-dropdown align="right">
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link class="cursor-pointer">
                                            <button {{-- onClick="document.getElementById('aiCourseGenerator').submit()" --}}
                                                @click="isOpen = true ; inputData = '{{ $subheading }}'; action='write an intro summary for this module based on this tile' ">
                                                write an intro summary for this module based on this tile
                                            </button>
                                        </x-dropdown-link>
                                        <x-dropdown-link class="cursor-pointer">
                                            <button
                                        ...
                                        <div
                                            ...
                                            <div class="p-5">
                                                <form wire:submit.prevent="aiCourseGenerator" id="aiCourseGenerator"
                                                    ...
                                                    <input class=" shadow-sm rounded-lg w-full p-2" name="action"
                                                        type="text" class="form-control" id="action"
                                                        wire:model="action" value="" x-model="action">

                                                    <input class=" shadow-sm rounded-lg w-full p-2" name="subheading"
